...
namespace Piwik\Plugins\EvenOdd\Reports;
 ...
 */
class GetMojRaport extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('EvenOdd_MojRaport');
        $this->dimension     = null;
        $this->documentation = Piwik::translate('XXX Opis');
        ...
        // $this->menuTitle    = 'EvenOdd_MojRaport';
        ...
        // $this->widgetTitle  = 'EvenOdd_MojRaport';
    }
    ...
    {
        $view = new View('@EvenOdd/getMojRaport');
        $view->myData = array();
